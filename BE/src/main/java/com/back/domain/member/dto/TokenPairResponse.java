...
public record TokenPairResponse(String accessToken, String refreshToken, boolean isNewMember,
    ...
    public TokenPairResponse(String accessToken, String refreshToken) {
        this(accessToken, refreshToken, false, null);
    }

    public TokenPairResponse(String accessToken, String refreshToken, boolean isNewMember) {
        this(accessToken, refreshToken, isNewMember, null);
    }
}
